...
export const socialLinks = [
    ...
    {id: 2, icon: facebookIcon, text: 'Facebook', to: ''},
    {id: 3, icon: twitterIcon, text: 'Twitter', to: ''},
    {id: 4, icon: instagramIcon, text: 'Instagram', to: 'https://www.instagram.com/gtg24.portal/'},
]